...
<input type="text" name="slug" class="form-control" placeholder="Slug" value="{{ $article->slug or ""  }}" >
<label for="" class="mt-3">Короткое описание</label>
<textarea type="text" name="description_short" class="form-control" id="description_short" placeholder="Короткое описание">{{$article->description_short or ""}} </textarea>
<label for="" class="mt-3">Полное описание</label>
<textarea type="text" name="description" class="form-control" id="description" placeholder="Полное описание">{{$article->description or ""}} </textarea>
